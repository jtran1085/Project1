...
char	Q[]	= "", T[]	= "TMP";
char	savedfile[FNSIZE], genbuf[BUFSIZ], file[FNSIZE], linebuf[LBSIZE], rhsbuf[LBSIZE/2], expbuf[BUFSIZ], buf[BUFSIZ];
...
int	iblock	= -1,	oblock	= -1, ichanged, nleft, names[26],anymarks, nbra, subnewa, subolda, fchange, wrapp, bpagesize = 20,col, listn, listf, oflag, vflag	= 1,buffer_pointer;
